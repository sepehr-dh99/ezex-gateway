...
func (ec *executionContext) marshalNVoidPayload2githubᚗcomᚋezexᚑioᚋezexᚑgatewayᚋinternalᚋadapterᚋgraphqlᚋgenᚐVoidPayload(ctx context.Context, sel ast.SelectionSet, v VoidPayload) graphql.Marshaler {
	return ec._VoidPayload(ctx, sel, &v)
}

func (ec *executionContext) marshalNVoidPayload2ᚖgithubᚗcomᚋezexᚑioᚋezexᚑgatewayᚋinternalᚋadapterᚋgraphqlᚋgenᚐVoidPayload(ctx context.Context, sel ast.SelectionSet, v *VoidPayload) graphql.Marshaler {
	if v == nil {
